...
class Game {
  constructor() {
    ...
    this.score = 0;
    this.highscore = localStorage.getItem("highscore") === null ? 0 :
  ...
  frameLooper(birdImg, bird) {
    ...
    if (this.gameStarted === false) {
      ...
      this.ctx.drawImage(gameStartImg, this.canvas.width / 2 - (325 / 2), 50, 325, 81);
      this.ctx.drawImage(instructionImg, this.canvas.width / 2 - (325 / 2), 400, 325, 81);
    }
...
<<<<<<< HEAD
  ...
  handleGameOver() {
    ...
    this.score = 0;
    this.ctx.imageSmoothingEnabled = false;
    this.ctx.drawImage(gameOverImg, this.canvas.width / 2 - (325 / 2), 50, 325, 81);
    this.ctx.drawImage(instructionImg, this.canvas.width / 2 - (325 / 2), 400, 325, 81);
  }
...
>>>>>>> 16337e579fd69480763069f623c3f4a00faddab4
